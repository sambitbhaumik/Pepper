...
export ESTDIR=/C/FestivalTTS/speech_tools
export FESTIVALDIR=/C/FestivalTTS/festival
export FESTVOXDIR=/C/FestivalTTS/festvox
export FREETTSDIR=/S/Sambit/Store/Area51/Bot/freetts
